...
| Version | Changes |
|---------|---------|
| 3.1.4 | Disabled setpoint step buttons while the climate entity is off, preventing TRV-style `OFF` target values from stepping into invalid low temperatures. |
